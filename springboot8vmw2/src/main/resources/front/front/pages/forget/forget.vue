<template>
	<view class="content">
			...
			<view class="forget-card" :style='{"boxShadow":"0 0 16rpx #59f43e","backgroundColor":"#fff","borderColor":"#ccc","borderRadius":"8rpx","borderStyle":"solid","borderWidth":"2rpx"}'>
				...
				<view class="login-input login-margin-b">
					<picker style="color: #888888;padding: 0 40upx;box-sizing:border-box;margin-top: 20upx;" @change="optionsChange" :value="index"
					 :range="options">
						<view class="uni-input" :style='{"lineHeight":"80rpx","fontSize":"28rpx","color":"rgba(255, 144, 0, 1)","textAlign":"left"}'>{{options[index]}}</view>
					</picker>
				</view>
			</view>
		</view>
		...
		<view class="forget-btn">
			<button class="landing" :style='{"borderColor":"#ccc","backgroundColor":"rgba(147, 193, 7, 1)","borderRadius":"8rpx","color":"rgba(255, 255, 255, 1)","borderWidth":"2rpx","fontSize":"32rpx","borderStyle":"solid","height":"88rpx"}' @tap="onResetPass" type="primary">重置密码</button>
		</view>
	</view>
</template>
