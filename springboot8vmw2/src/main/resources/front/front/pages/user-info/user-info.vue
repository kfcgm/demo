<template>
	<view class="content">
		...
		<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","borderColor":"rgba(242, 241, 241, 1)","margin":"0 0 0px 0","borderStyle":"solid","borderWidth":"0 0 2rpx 0","height":"108rpx"}' v-if="tableName=='yonghu'" class="cu-form-group">
			...
			<input  style="padding: 0 30upx" :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(230, 230, 230, 1)","borderRadius":"0px","color":"rgba(255, 144, 0, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.shouji" placeholder="手机"></input>
		</view>
		<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","borderColor":"rgba(242, 241, 241, 1)","margin":"0 0 0px 0","borderStyle":"solid","borderWidth":"0 0 2rpx 0","height":"108rpx"}' v-if="tableName=='gongjiang'" class="cu-form-group">
		...
		<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","borderColor":"rgba(242, 241, 241, 1)","margin":"0 0 0px 0","borderStyle":"solid","borderWidth":"0 0 2rpx 0","height":"108rpx"}' v-if="tableName=='gongjiang'" class="cu-form-group">
			...
			<view v-if="tableName=='gongjiang'" :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#ccc","margin":"0","borderWidth":"0 0 2rpx 0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group select">
                                <view :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left"}' class="title">性别</view>
                                <picker @change="gongjiangxingbieChange" :value="gongjiangxingbieIndex" :range="gongjiangxingbieOptions">
                                        <view style="padding: 0 30upx" :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(230, 230, 230, 1)","borderRadius":"0px","color":"rgba(255, 144, 0, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' class="uni-input picker-select-input">{{ruleForm.xingbie?ruleForm.xingbie:"请选择性别"}}</view>
                                </picker>
                        </view>
		<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","borderColor":"rgba(242, 241, 241, 1)","margin":"0 0 0px 0","borderStyle":"solid","borderWidth":"0 0 2rpx 0","height":"108rpx"}' v-if="tableName=='gongjiang'" @tap="gongjiangtouxiangTap" class="cu-form-group" :class="left == 'left'?'':'active'">
			<view class="title" :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left"}'>头像</view>
			<image :style='{"width":"88rpx","boxShadow":"0 0 16rpx rgba(0,0,0,.3)","borderRadius":"100%","textAlign":"left","height":"88rpx"}' v-if="ruleForm.touxiang" class="avator" :src="ruleForm.touxiang" mode=""></image>
			<image :style='{"width":"88rpx","boxShadow":"0 0 16rpx rgba(0,0,0,.3)","borderRadius":"100%","textAlign":"left","height":"88rpx"}' v-else class="avator" src="../../static/center/face.jpeg" mode=""></image>
		</view>
		<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","borderColor":"rgba(242, 241, 241, 1)","margin":"0 0 0px 0","borderStyle":"solid","borderWidth":"0 0 2rpx 0","height":"108rpx"}' v-if="tableName=='gongjiang'" class="cu-form-group">
			<view class="title" :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left"}'>工种</view>
			<input  style="padding: 0 30upx" :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(230, 230, 230, 1)","borderRadius":"0px","color":"rgba(255, 144, 0, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.gongzhong" placeholder="工种"></input>
		</view>
		<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","borderColor":"rgba(242, 241, 241, 1)","margin":"0 0 0px 0","borderStyle":"solid","borderWidth":"0 0 2rpx 0","height":"108rpx"}' v-if="tableName=='gongjiang'" class="cu-form-group">
			<view class="title" :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left"}'>身份证</view>
			<input  style="padding: 0 30upx" :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(230, 230, 230, 1)","borderRadius":"0px","color":"rgba(255, 144, 0, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.shenfenzheng" placeholder="身份证"></input>
		...
		<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","borderColor":"rgba(242, 241, 241, 1)","margin":"0 0 0px 0","borderStyle":"solid","borderWidth":"0 0 2rpx 0","height":"108rpx"}' v-if="tableName=='gongjiang'" class="cu-form-group">
			<view class="title" :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left"}'>联系电话</view>
	...
	export default {
		data() {
			return {
				...
				gongjiangxingbieOptions: [],
				gongjiangxingbieIndex: 0,
			}
		},
		async onLoad() {
			...
			// 自定义下拉框值
			if(this.tableName=='gongjiang'){
				this.gongjiangxingbieOptions = "男,女".split(',');
				this.gongjiangxingbieOptions.forEach((item, index) => {
					if(item==this.ruleForm.xingbie) {
						this.gongjiangxingbieIndex = index;
					}
				});
			}
			this.styleChange()
		...
		methods: {
                        ...
                        // 下拉变化
                        gongjiangxingbieChange(e) {
                                this.gongjiangxingbieIndex = e.target.value
                                this.ruleForm.xingbie = this.gongjiangxingbieOptions[this.gongjiangxingbieIndex]
                        },
			styleChange() {
				this.$nextTick(()=>{
			...
			async update() {
				...
				if((!this.ruleForm.zhanghao) && `gongjiang` == this.tableName){
					this.$utils.msg(`账号不能为空`);
					return
				}
				if((!this.ruleForm.mima) && `gongjiang` == this.tableName){
					this.$utils.msg(`密码不能为空`);
					return
				}
				if(`gongjiang` == this.tableName && this.ruleForm.shenfenzheng&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzheng))){
					this.$utils.msg(`身份证应输入身份证格式`);
					return
				}
				if(`gongjiang` == this.tableName && this.ruleForm.lianxidianhua&&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){
					this.$utils.msg(`联系电话应输入手机格式`);
					return
				}
				if(`gongjiang` == this.tableName && this.ruleForm.money&&(!this.$validate.isNumber(this.ruleForm.money))){
					this.$utils.msg(`余额应输入数字`);
					return
				}
				let table = uni.getStorageSync("nowTable");
