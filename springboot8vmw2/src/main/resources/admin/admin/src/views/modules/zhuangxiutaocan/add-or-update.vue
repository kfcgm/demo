  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="套餐名称" prop="taocanmingcheng">
              <el-input v-model="ruleForm.taocanmingcheng" 
                placeholder="套餐名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="装修类型" prop="zhuangxiuleixing">
          <el-select v-model="ruleForm.zhuangxiuleixing" placeholder="请选择装修类型">
            <el-option
                v-for="(item,index) in zhuangxiuleixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="装修类型" prop="zhuangxiuleixing">
	      <el-input v-model="ruleForm.zhuangxiuleixing"
                placeholder="装修类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
          ...
          <el-form-item class="input" label="价格" prop="jiage">
              <el-input v-model="ruleForm.jiage" 
                placeholder="价格" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="完工时间" prop="wangongshijian">
          <el-input v-model="ruleForm.wangongshijian" 
              placeholder="完工时间" clearable  :readonly="ro.wangongshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="完工时间" prop="wangongshijian">
              <el-input v-model="ruleForm.wangongshijian" 
                placeholder="完工时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                                                                ...
                                                                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="装修材料" prop="zhuangxiucailiao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="装修材料"
                  v-model="ruleForm.zhuangxiucailiao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhuangxiucailiao" label="装修材料" prop="zhuangxiucailiao">
                    <span>{{ruleForm.zhuangxiucailiao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                                                                                                                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="装修详情" prop="zhuangxiuxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.zhuangxiuxiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhuangxiuxiangqing" label="装修详情" prop="zhuangxiuxiangqing">
                    <span v-html="ruleForm.zhuangxiuxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	zhuangxiuleixing : false,
	tupian : false,
	jiage : false,
	zhuangxiucailiao : false,
	wangongshijian : false,
	zhuangxiuxiangqing : false,
	lianxidianhua : false,
	faburiqi : false,
	zhanghao : false,
	xingming : false,
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.taocanmingcheng = true;
            continue;
	            	            ...
	            	            if(o=='zhuangxiuleixing'){
            this.ruleForm.zhuangxiuleixing = obj[o];
	    this.ro.zhuangxiuleixing = true;
            continue;
          }
	            	            if(o=='tupian'){
	    ...
	    this.ro.jiage = true;
            continue;
	            	            ...
	            	            if(o=='zhuangxiucailiao'){
            this.ruleForm.zhuangxiucailiao = obj[o];
	    this.ro.zhuangxiucailiao = true;
            continue;
          }
	            	            if(o=='wangongshijian'){
	    ...
	    this.ro.wangongshijian = true;
            continue;
	            	            ...
	            	            if(o=='zhuangxiuxiangqing'){
            this.ruleForm.zhuangxiuxiangqing = obj[o];
	    this.ro.zhuangxiuxiangqing = true;
            continue;
          }
	            	            if(o=='lianxidianhua'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `zhuangxiutaocan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhuangxiutaocanCrossAddOrUpdateFlag = false;
                  this.parent.search();
