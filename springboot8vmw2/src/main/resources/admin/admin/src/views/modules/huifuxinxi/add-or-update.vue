          ...
          <el-form-item class="input" label="用户姓名" prop="yonghuxingming">
              <el-input v-model="ruleForm.yonghuxingming" 
                placeholder="用户姓名" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="回复日期" prop="huifuriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.huifuriqi" 
                type="date"
                placeholder="回复日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.huifuriqi" label="回复日期" prop="huifuriqi">
              <el-input v-model="ruleForm.huifuriqi" 
                placeholder="回复日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                                                                ...
                                                                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="聊天回复" prop="liaotianhuifu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="聊天回复"
                  v-model="ruleForm.liaotianhuifu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.liaotianhuifu" label="聊天回复" prop="liaotianhuifu">
                    <span>{{ruleForm.liaotianhuifu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
