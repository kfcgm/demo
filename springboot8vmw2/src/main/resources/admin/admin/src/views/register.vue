  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.26);borderRadius:10px">
        <h1 class="h1" style="color:rgba(255, 255, 255, 1);fontSize:28px;">巧匠家装小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机" type="text" />
																																	...
																																	<!-- <div v-if="tableName=='gongjiang'" class="input-group">
			   <div class="label">账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhanghao" class="input" type="text" placeholder="账号">
			   </div>
			 </div> -->
			<el-form-item label="账号" class="input" v-if="tableName=='gongjiang'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='gongjiang'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='gongjiang'" class="input-group">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='gongjiang'">
			  <el-input v-model="ruleForm.xingming" autocomplete="off" placeholder="姓名" type="text" />
			</el-form-item>
																														<!-- <div v-if="tableName=='gongjiang'" class="input-group">
			   <div class="label">工种</div>
			   <div class="input-container">
			     <input v-model="ruleForm.gongzhong" class="input" type="text" placeholder="工种">
			   </div>
			 </div> -->
			<el-form-item label="工种" class="input" v-if="tableName=='gongjiang'">
			  <el-input v-model="ruleForm.gongzhong" autocomplete="off" placeholder="工种" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='gongjiang'" class="input-group">
			   <div class="label">身份证</div>
			   <div class="input-container">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='gongjiang'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='gongjiang'" class="input-group">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='gongjiang'">
